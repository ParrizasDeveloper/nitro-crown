      ...
      `}>
        ...
        `}>
          <h1
            ...
            bg-clip-text bg-radial-[at_50%_75%] from-primary/50 via-50% via-neutral-800/50 
          ...
          `}>
              <ArrowLeft
                onClick={slideLeft}
                className={`
                  h-20 cursor-pointer text-white hover:text-primary hover:scale-110 transition 
                  duration-150
                `}
              />
              <ArrowRight
