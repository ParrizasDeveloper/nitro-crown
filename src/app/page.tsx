...
export default function Home() {
  ...
  return (
    <>
      ...
      `}>
        <div className={`
          relative flex flex-col justify-center items-center h-[888px]
        `}>
          <h1
            ref={titleElement}
            className={`${anton.className}
            lg:absolute 2xl:text-[18rem] 2xl:top-0 tracking-widest leading-none text-transparent 
            bg-clip-text bg-radial-[at_50%_75%] from-gold/50 via-70% via-neutral-800/50 
            to-black xl:text-[15rem] xl:top-[100px] lg:text-[12rem] lg:top-[210px]
          `}
          >
          ...
          <div
            ...
            className={`
            relative lg:absolute left-0 w-full flex top-[80px] z-20
          `}
          >
            {mainCars?.map(car => (
          ...
          <div className={`
          absolute 2xl:w-[2000px] aspect-square z-10  rounded-full 2xl:top-[-340px]
